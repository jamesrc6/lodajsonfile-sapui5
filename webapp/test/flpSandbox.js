		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#axeleraloadjsonfile-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"axeleraloadjsonfile-display": {
								"semanticObject": "axeleraloadjsonfile",
								"action": "display",
								"description": "Load JSON File application.",
								"title": "Load JSON File",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=axelera.loadjsonfile",
									"url": sap.ui.require.toUrl("axelera/loadjsonfile")
								}
							}
						}
					}
